...
class VectorDatabase:
    ...
    def get_or_create_collection(self, collection_name: Optional[str] = None) -> Collection:
        ...
        try:
            ...
            console.print(f"[yellow]loaded existing collection: {self.collection_name}[/yellow]")
        except:
    ...
    def delete_collection(self, collection_name: Optional[str] = None):
        ...
        try:
            ...
            console.print(f"[yellow]collection {name} doesn't exist or error: {e}[/yellow]")
    ...
    def delete_video_segments(self, video_id: str):
        ...
        if results["ids"]:
            ...
            console.print(f"[red]deleted {len(results['ids'])} segments for video {video_id}[/red]")
        else:
